...
<br>
<div class="dropdown">
<div id="dropdownToggle" class="dropdown-toggle"><span class="dropText">Selecione um país</span></div>
    <ul id="dropdownMenu" class="dropdown-menu">
        <li data-value="no-say">Prefiro não dizer</li>
        ...
        <li data-value="BO">Bolivia (Plurinational State of)</li>
        ...
        <li data-value="BN">Brunei Darussalam</li>
        ...
        <li data-value="CT">China/Taiwan</li>
        ...
        <li data-value="CRe">Cote D'ivoire</li>
        <li data-value="HR">Croatia</li>
        <li data-value="CU">Cuba</li>
        <li data-value="CW">Curaçao</li>
        ...
        <li data-value="SZ">Eswatini (Swaziland)</li>
        ...
        <li data-value="MO">Macao</li>
        <li data-value="MK">Macedonia, The Former Yugoslav Republic of</li>
        ...
        <li data-value="RE">Reunion</li>
        <li data-value="ROU">Romania</li>
        <li data-value="RU">Russian Federation</li>
        <li data-value="RW">Rwanda</li>
        <li data-value="BL">Saint Barthelemy</li>
        <li data-value="SH">Saint Helena</li>
        <li data-value="KN">Saint Kitts and Nevis</li>
        <li data-value="LC">Saint Lucia</li>
        <li data-value="MF">Saint Martin</li>
        ...
        <li data-value="SX">Sint Maarten</li>
        ...
        <li data-value="TR">Turkey (Türkiye)</li>
